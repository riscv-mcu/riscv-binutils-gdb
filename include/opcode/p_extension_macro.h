...
#define MATCH_DADD8 0x4800707f
#define MASK_DADD8  0xfe00707f
#define MATCH_DRADD8 0x800707f
#define MASK_DRADD8  0xfe00707f
#define MATCH_DURADD8 0x2800707f
#define MASK_DURADD8  0xfe00707f
#define MATCH_DKADD8 0x1800707f
#define MASK_DKADD8  0xfe00707f
#define MATCH_DUKADD8 0x3800707f
#define MASK_DUKADD8  0xfe00707f
#define MATCH_DSUB8 0x4a00707f
#define MASK_DSUB8  0xfe00707f
#define MATCH_DRSUB8 0xa00707f
#define MASK_DRSUB8  0xfe00707f
#define MATCH_DURSUB8 0x2a00707f
#define MASK_DURSUB8  0xfe00707f
#define MATCH_DKSUB8 0x1a00707f
#define MASK_DKSUB8  0xfe00707f
#define MATCH_DUKSUB8 0x3a00707f
#define MASK_DUKSUB8  0xfe00707f
#define MATCH_DSMIN8 0x8800707f
#define MASK_DSMIN8  0xfe00707f
#define MATCH_DUMIN8 0x9800707f
#define MASK_DUMIN8  0xfe00707f
#define MATCH_DSMAX8 0x8a00707f
#define MASK_DSMAX8  0xfe00707f
#define MATCH_DUMAX8 0x9a00707f
#define MASK_DUMAX8  0xfe00707f
#define MATCH_DKABS8 0xad00707f
#define MASK_DKABS8  0xfff0707f
#define MATCH_DSCLIP8 0x8c00707f
#define MASK_DSCLIP8  0xff80707f
#define MATCH_DUCLIP8 0x8d00707f
#define MASK_DUCLIP8  0xff80707f
#define MATCH_DKHM8 0x8e00707f
#define MASK_DKHM8  0xfe00707f
#define MATCH_DKSLRA8 0x5e00707f
#define MASK_DKSLRA8  0xfe00707f
#define MATCH_DADD16 0x4000707f
#define MASK_DADD16  0xfe00707f
#define MATCH_DRADD16 0x707f
#define MASK_DRADD16  0xfe00707f
#define MATCH_DURADD16 0x2000707f
#define MASK_DURADD16  0xfe00707f
#define MATCH_DKADD16 0x1000707f
#define MASK_DKADD16  0xfe00707f
#define MATCH_DUKADD16 0x3000707f
#define MASK_DUKADD16  0xfe00707f
#define MATCH_DSUB16 0x4200707f
#define MASK_DSUB16  0xfe00707f
#define MATCH_DRSUB16 0x200707f
#define MASK_DRSUB16  0xfe00707f
#define MATCH_DURSUB16 0x2200707f
#define MASK_DURSUB16  0xfe00707f
#define MATCH_DKSUB16 0x1200707f
#define MASK_DKSUB16  0xfe00707f
#define MATCH_DUKSUB16 0x3200707f
#define MASK_DUKSUB16  0xfe00707f
#define MATCH_DSMIN16 0x8000707f
#define MASK_DSMIN16  0xfe00707f
#define MATCH_DUMIN16 0x9000707f
#define MASK_DUMIN16  0xfe00707f
#define MATCH_DSMAX16 0x8200707f
#define MASK_DSMAX16  0xfe00707f
#define MATCH_DUMAX16 0x9200707f
#define MASK_DUMAX16  0xfe00707f
#define MATCH_DKABS16 0xad10707f
#define MASK_DKABS16  0xfff0707f
#define MATCH_DSCLIP16 0x8400707f
#define MASK_DSCLIP16  0xff00707f
#define MATCH_DUCLIP16 0x8500707f
#define MASK_DUCLIP16  0xff00707f
